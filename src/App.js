...
class Game extends Component {
    ...
    solve() {
        ...
        var r = window.confirm("Are you sure to check the answer? You cannot continue to solve the problem after viewing it. ")
        if (!r) {
            return
        } else {
            this.setState({
